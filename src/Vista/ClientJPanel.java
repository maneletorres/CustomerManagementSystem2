...
public class ClientJPanel extends JPanel {
     ...
     */
    public ClientJPanel(JTextField jTextField) {
        ClientJPanel.jTextField = jTextField;
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(700, 240));
    ...
    private void clientJTableFormMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clientJTableFormMousePressed
        ...
        /*if (evt.getClickCount() == 2) {
            int lastRow = clientJTableForm.getRowCount() - 1;
            Client c = (Client) miModelo.getClientData().get(lastRow);
    ...
    private void acceptClientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptClientJButtonActionPerformed
        ...
        if (isEditing) {
            ...
            // Alternativa 2 - La finestra 'Selecció Clients' permet l'edició únicament del registre que s'afig:
            // --- Comentar el bucli if / else, així com el contingut del if. ---
            int selectedRow = clientJTableForm.getSelectedRow();
            if (selectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(this,
                        "No pots acceptar un client sense seleccionar cap registre.", "Informació",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void deleteClientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteClientJButtonActionPerformed
        if (isEditing) {
            ...
            if (lastSelectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(this,
                        "No pots eliminar un client sense seleccionar cap registre.", "Informació",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    public JButton getAcceptClientJButton() {
        return acceptClientJButton;
    }
